...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.ViewHolder>
{
    ...
    public BookmarkAdapter(Context context, List<Bookmark> Bookmark) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(item != null){
            holder.tvName.setText(item.getProfile().getName());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            imgBookmark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mIOnItemClickedListener != null) {
                        mIOnItemClickedListener.onItemClickBookmark(getLayoutPosition(), mData.get(getLayoutPosition()).getId());
                    }
                }
            });
        }
