...
import nauq.mal.com.formapp.adapters.MenuChoosePracticeAdapter;
...
public class PracticeFragment extends BaseFragment implements View.OnClickListener{
    ...
    private MenuChoosePracticeAdapter mAdapter;
    ...
    protected void initComponents() {
        ...
        mAdapter = new MenuChoosePracticeAdapter(mContext, mData);
...
//                            loadData();
        ...
        mAdapter.setOnItemClickListener(new MenuChoosePracticeAdapter.IOnItemClickedListener() {
            @Override
...
//                test get id item choose
                ...
                Intent i = new Intent(getActivity(), DoPracticeActivity.class);
                startActivity(i);
                break;
        }
    }
