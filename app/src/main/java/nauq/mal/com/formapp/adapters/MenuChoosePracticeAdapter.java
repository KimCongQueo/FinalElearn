...
public class MenuChoosePracticeAdapter extends RecyclerView.Adapter<MenuChoosePracticeAdapter.ViewHolder> {
    ...
    public MenuChoosePracticeAdapter(Context context, List<TopicVocaItem> TopicVocaItem) {
    ...
    @Override
    public void onBindViewHolder(MenuChoosePracticeAdapter.ViewHolder holder, int position) {
