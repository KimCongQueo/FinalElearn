...
import nauq.mal.com.formapp.adapters.MenuChooseVocabularyAdapter;
import nauq.mal.com.formapp.fragments.BaseFragment;
import nauq.mal.com.formapp.models.TopicVocaItem;

public class VocabFragment extends BaseFragment implements View.OnClickListener {
    ...
    private MenuChooseVocabularyAdapter mAdapter;
...
//        mAdapter = new MenuChooseVocabularyAdapter(mContext, mData);
        mAdapter = new MenuChooseVocabularyAdapter(mContext, mData);
...
//        mAdapter.setOnItemClickListener(new MenuChooseVocabularyAdapter.IOnItemClickedListener() {
//            @Override
