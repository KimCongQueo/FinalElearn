...
public class MenuChooseVocabularyAdapter extends RecyclerView.Adapter<MenuChooseVocabularyAdapter.ViewHolder> {
    ...
    public MenuChooseVocabularyAdapter(Context context, List<TopicVocaItem> TopicVocaItem) {
        this.mContext = context;
        this.mData = TopicVocaItem;
    }
    public void onItemClickSelectAll(boolean selectAlll) {
        this.selectAll = selectAlll;
    }
